...
import amf.plugins.domain.shapes.metamodel.AnyShapeModel.{Comment, Documentation, XMLSerialization}
import amf.plugins.domain.webapi.annotations.TypePropertyLexicalInfo
import amf.plugins.domain.webapi.models.{CreativeWork, DocumentedElement}
